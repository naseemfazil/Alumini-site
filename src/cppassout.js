...
class Cppassout extends Component
{
    constructor()
    {
        ...
        button()
        {
            this.setState({Firstname:this.state.Firstname,Lastname:this.state.Lastname,DOB:this.state.DOB})
            this.setState({Yearofpassout:this.state.Yearofpassout,WorkingExprience:this.state.WorkingExprience})
            this.setState({WorkingField:this.state.WorkingField,OnGoingProject:this.state.OnGoingProject})
            ...
            axios.post('http://localhost:3001/savePassedout',user)
            .then(response =>{
    ...
    render()
    {
        return(
            <div className="backgroud">
                <h3 className="m-3 d-flex justify-content-center">Passedout Student Profile</h3>  
                <Form className="form">
                {/* <h1 style={{fontFamily: "Times New Roman, Times, serif"}}>Create Profile</h1> */}
                <Label className="mt-3 mb-3">First Name</Label>
                <Input type="text" value={this.state.Firstname} onChange={this.firstname} placeholder="Firstname"/>
                <Label className="mt-3 mb-3">Last Name</Label>
                <Input type="text" value={this.state.Lastname} onChange={this.lastname} placeholder="Lastname"/>
                <Label className="mt-3 mb-3">Date of Birth</Label>
                <Input type="date" value={this.state.DOB} onChange={this.dob} placeholder="dateofbrith"/>
                ...
                <Input type="text" value={this.state.Yearofpassout} onChange={this.yearofpassout}placeholder="Year of passout"/>
                <Label className="mt-3 mb-3">Working Exprience</Label>
                <Input type="text" value={this.state.WorkingExprience} onChange={this.workingexprience} placeholder="Exprience"/>
                <Label className="mt-3 mb-3">Working Field</Label>
                <Input type="text" value={this.state.WorkingField} onChange={this.workingfield} placeholder="Working Field"/>
                <Label className="mt-3 mb-3">On going project</Label>
                <Input type="text" value={this.state.OnGoingProject} onChange={this.ongoingproject} placeholder="On going project"/>
